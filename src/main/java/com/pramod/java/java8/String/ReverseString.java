package com.pramod.java.java8.String;
...
//        System.out.println("reversed String is " + " " + reverseUsingCollect);
        ...
        String str = "My name is Pramod";

        String updatedone =  ps.splitAsStream(str).map(ms->new StringBuilder(ms).reverse()).collect(Collectors.joining(" "));
